import { SimpleForm, DateInput, Edit, TextInput, ReferenceInput, BooleanInput, NumberInput, ReferenceArrayInput, ArrayInput, SimpleFormIterator, SelectInput  } from "react-admin";
...
export const CadeauxEdit = () => {
  ...
  const transform = (data) => {
    const formattedData = {
        ...
        selectedOptions: isDefinedAndNotVoid(data?.selectedOptions) ? data.selectedOptions.map(o => getFormattedValueForBackEnd(o)) : [],
    };
