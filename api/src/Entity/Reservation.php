...
class Reservation implements TenantAwareInterface
{
    ...
    #[ORM\JoinTable(name: 'reservation_selected_options')]
    #[Groups(groups: ['Reservation:write', 'Reservation:read'])]
    ...
    #[ORM\Column(nullable: true)]
    #[Groups(groups: ['Reservation:write', 'Reservation:read'])]
    private ?bool $notificationReceived = null;

    #[ORM\Column(length: 10, unique: true, nullable: true)]
    #[Groups(groups: ['Reservation:read'])]
    private ?string $publicShortcode = null;
    ...
    public function isNotificationReceived(): ?bool
    {
        return $this->notificationReceived;
    }

    public function setNotificationReceived(?bool $notificationReceived): static
    {
        $this->notificationReceived = $notificationReceived;
        return $this;
    }

    public function getPublicShortcode(): ?string
    {
        return $this->publicShortcode;
    }

    public function setPublicShortcode(?string $publicShortcode): static
    {
        $this->publicShortcode = $publicShortcode;
        return $this;
    }
}
