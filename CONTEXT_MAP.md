...
|---|---------|---------|--------------|------|
| 1 | [context.mdc](.cursor/rules/context.mdc) | **Vue d'ensemble** (stack, infra, modules, entités, multi-tenant, migration) | 2026-04-09 | A jour |
...
|---|---------|---------|--------------|--------------|
| 5 | [context-code-map.mdc](.cursor/rules/context-code-map.mdc) | Cartographie du code | `api/src/**`, `pwa/components/**`, `pwa/app/**` | 2026-03-26 |
...
| 9 | [context-deploy.mdc](.cursor/rules/context-deploy.mdc) | Déploiement Docker | `compose.yaml`, `Dockerfile` | 2026-03-26 |
